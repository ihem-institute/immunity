...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2022-04-06 20:26:42 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5429" name="k" value="100000"/>
          <Constant key="Parameter_5416" name="enhancer" value="18"/>
          <Constant key="Parameter_5424" name="pH" value="7"/>
          <Constant key="Parameter_5431" name="pHlimit" value="7.3"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_271">
  ...
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5418" name="k" value="0.766"/>
          <Constant key="Parameter_5430" name="enhancer" value="-9"/>
          <Constant key="Parameter_5423" name="pH" value="7"/>
      ...
      <Reaction key="Reaction_12" name="disTf" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_12">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5422" name="k1" value="2000"/>
          <Constant key="Parameter_5286" name="k2" value="2e+10"/>
        </ListOfConstants>
      ...
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[disTf]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[disTf],ParameterGroup=Parameters,Parameter=k2" value="20000000000" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
  ...
  <GUI>
    <ListOfSliders>
      ...
      <Slider key="Slider_8" associatedEntityKey="Task_11" objectCN="CN=Root,Model=AntigenPresentation,Vector=Reactions[disTf],ParameterGroup=Parameters,Parameter=k1,Reference=Value" objectType="float" objectValue="2000" minValue="5" maxValue="20000" tickNumber="1000" tickFactor="100" scaling="linear"/>
    </ListOfSliders>
  </GUI>
