...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2022-02-14 20:08:45 UTC -->
...
Notice that at pH = phlimit, the factor is 1.  k then is the kinetics constant at the pHlimit
  ...
  <Model key="Model_0" name="AntigenPresentation" simulationType="time" timeUnit="s" volumeUnit="nm³" areaUnit="nm²" lengthUnit="nm" quantityUnit="pmol" type="stochastic" avogadroConstant="6.0221417899999999e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5443" name="k" value="10"/>
          <Constant key="Parameter_5444" name="pH" value="-9.64327e-17"/>
          <Constant key="Parameter_5438" name="pHlimit" value="5.8"/>
          <Constant key="Parameter_5440" name="enhancer" value="3"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5442" name="k1" value="0"/>
          <Constant key="Parameter_5445" name="k2" value="0"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5436" name="k" value="1e-05"/>
          <Constant key="Parameter_3316" name="pH" value="-9.64327e-17"/>
          <Constant key="Parameter_3314" name="pHlimit" value="6"/>
          <Constant key="Parameter_5437" name="enhancer" value="-1.5"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_3315" name="k" value="1e-06"/>
          <Constant key="Parameter_5414" name="pH" value="-9.64327e-17"/>
          <Constant key="Parameter_5412" name="pHlimit" value="6"/>
          <Constant key="Parameter_5411" name="enhancer" value="-1.5"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble]">
          <ListOfCallParameters>
            ...
            <CallParameter functionParameter="FunctionParameter_268">
              <SourceParameter reference="Parameter_5412"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_267">
              <SourceParameter reference="ModelValue_3"/>
            </CallParameter>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5413" name="k" value="0.01"/>
          <Constant key="Parameter_5417" name="pH" value="-9.64327e-17"/>
          <Constant key="Parameter_5432" name="pHlimit" value="5.8"/>
          <Constant key="Parameter_5420" name="enhancer" value="3"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_271">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_9">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble],Vector=Metabolites[ovaEn]" value="6.0221417899999999e+23" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane],Vector=Metabolites[exCxEn]" value="6.02214179e+17" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble],Vector=Metabolites[bMGEn]" value="6.0221417900000003e+21" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble],Vector=Metabolites[protonEn]" value="6.0221417900000005e+20" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[soluble],Vector=Metabolites[protonCy]" value="6.0221417900000027e+19" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane],Vector=Metabolites[cMHCIEn]" value="6.02214179e+17" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[membrane],Vector=Metabolites[imCxEn]" value="6.02214179e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[imaginario],Vector=Metabolites[RabD]" value="1083985522200" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[imaginario],Vector=Metabolites[RabA]" value="60221417900" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[imaginario],Vector=Metabolites[area]" value="6022141790000000" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Compartments[imaginario],Vector=Metabolites[volume]" value="6.02214179e+17" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[ProtonLeak]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[ProtonLeak],ParameterGroup=Parameters,Parameter=k1" value="0" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=AntigenPresentation,Vector=Reactions[ProtonLeak],ParameterGroup=Parameters,Parameter=k2" value="0" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 0 6.0221417900000005e+20 0 0 0 0 6.0221417899999999e+23 6.02214179e+17 -9.6432746655328696e-17 0.0014400000000000001 1.0000000000000002e-06 6.0221417900000027e+19 6.0221417900000003e+21 6.02214179e+17 6.02214179e+17 1083985522200 60221417900 6022141790000000 6.02214179e+17 1000000 10000 1 0.00020000000000000001 3 -1.5 
    </InitialState>
  </Model>
  <ListOfTasks>
