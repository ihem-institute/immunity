 ...
 */		
		...
		String organelle = ModelProperties.getInstance().getRabOrganelle().get(maxRab);    
			...
			else if (organelle.equals("GSV")) recycleRE(endosome, maxRab);
...
//			to delete the 100% of the TGN and 4% of the RE or GSV fusing with PM
			if (	maxRab.equals("RabE")
					|| (maxRab.equals("RabC") && Math.random()<0.04)// era 0.02
					|| (maxRab.equals("RabL") && Math.random()<0.04)
