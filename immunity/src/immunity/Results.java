...
//		Copy the input file from data to folder with the Results
	{
	File source = new File("C:/Users/lmayo/workspace-glut4/immunity/data/"+inputFile);
...
//	Copy the inputFrozenEndosomes file from data to folder with the Results
	{
	File source = new File("C:/Users/lmayo/workspace-glut4/immunity/data/inputFrozenEndosomes.csv");
