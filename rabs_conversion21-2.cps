...
<!-- generated with COPASI 4.15 (Build 95) (http://www.copasi.org) at 2017-02-19 21:31:44 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_21">
    <dcterms:created>
      ...
      <Metabolite key="Metabolite_23" name="species_1" simulationType="reactions" compartment="Compartment_1">
      </Metabolite>
      <Metabolite key="Metabolite_25" name="Rab0" simulationType="reactions" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4992" name="k1" value="1e-007"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4991" name="k1" value="1e-007"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4990" name="area" value="5000"/>
          <Constant key="Parameter_4989" name="kass" value="1e-007"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4988" name="area" value="5000"/>
          <Constant key="Parameter_4987" name="kdis" value="5e-005"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4986" name="area" value="5000"/>
          <Constant key="Parameter_4985" name="kass" value="1e-007"/>
        </ListOfConstants>
        <KineticLaw function="Function_41">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_265">
  ...
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4984" name="area" value="5000"/>
          <Constant key="Parameter_4983" name="kdis" value="5e-005"/>
        </ListOfConstants>
        <KineticLaw function="Function_40">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_254">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4982" name="area" value="5000"/>
          <Constant key="Parameter_4981" name="kdis" value="5e-005"/>
        </ListOfConstants>
        <KineticLaw function="Function_40">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_254">
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4980" name="area" value="5000"/>
          <Constant key="Parameter_4979" name="kdis" value="5e-005"/>
        </ListOfConstants>
        <KineticLaw function="Function_40">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_254">
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4978" name="area" value="5000"/>
          <Constant key="Parameter_4977" name="kdis" value="5e-005"/>
        </ListOfConstants>
        <KineticLaw function="Function_40">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_254">
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4976" name="area" value="5000"/>
          <Constant key="Parameter_4975" name="kass" value="1e-007"/>
        </ListOfConstants>
        <KineticLaw function="Function_41">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_265">
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4974" name="area" value="5000"/>
          <Constant key="Parameter_4973" name="kass" value="1e-007"/>
        </ListOfConstants>
        <KineticLaw function="Function_41">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_265">
  ...
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4972" name="area" value="5000"/>
          <Constant key="Parameter_4971" name="kass" value="1e-007"/>
        </ListOfConstants>
        <KineticLaw function="Function_41">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_265">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[area]" value="3.011070895e+024" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[RabEc]" value="3.011070895e+024" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[RabEm]" value="3.011070895e+024" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[species_1]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[Rab0]" value="1.204428358e+024" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[area]" value="4999.999999999999" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Rab5ass]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Rab5ass],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Rab5dis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Rab5dis],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabBass]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabBass],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabBdis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabBdis],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabCdis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabCdis],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabDdis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabDdis],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabEdis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabEdis],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabCass]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabCass],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabDass]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabDass],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[RabEass]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[RabEass],ParameterGroup=Parameters,Parameter=area" value="4999.999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[area],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
    ...
    <InitialState type="initialState">
      0 1.204428358e+024 0 0 0 0 3.011070895e+024 0 3.011070895e+024 0 0 0 4999.999999999999 3.011070895e+024 0 1 1e-007 5e-005 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_15" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
        ...
        <Parameter name="StepSize" type="float" value="400"/>
      ...
      <ListOfPlotItems>
        <PlotItem name="[RabA]" type="Curve2D">
          ...
          <ListOfChannels>
            ...
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[RabA],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[RabB]" type="Curve2D">
          <Parameter name="Color" type="string" value="auto"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[RabB],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
